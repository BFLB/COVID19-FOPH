...
class Locations(dict):
  def __init__(self): 
    ...
    self["FR"] = Location("FR"        , "Fribourg"              , "Fribourg"         , 46.718391 , 7.074008  )
    self["GE"] = Location("GE"        ,	"Genève"                , "Geneva"           , 46.195602 , 6.148113  )
    ...
    self["NE"] = Location("NE"        ,	"Neuchatel"             ,	"Neuchâtel"        , 46.995534 , 6.780126  )
    ...
    self["TI"] = Location("TI"        , "Ticino"                , "Ticino"           , 46.009279 , 8.955576  )
    self["UR"] = Location("UR"        , "Uri"                   , "Uri"              , 46.880422 , 8.644409  )
    self["VD"] = Location("VD"        , "Vaud"                  , "Vaud"             , 46.536900 , 6.584780  )
    self["VS"] = Location("VS"        , "Valais"                , "Valais"           , 46.209567 , 7.604659  )
